...
class CreateMachineChecksheetDtsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('machine_checksheet_dts', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('checksheetmc_hd_id')->nullable();
            $table->bigInteger('checksheetmc_dt_id')->nullable();
            $table->string('checksheetmc_hd_docuno')->nullable();
            $table->string('machinecheck_dt_listno',10)->nullable();
            $table->string('machinecheck_dt_name',500)->nullable();
