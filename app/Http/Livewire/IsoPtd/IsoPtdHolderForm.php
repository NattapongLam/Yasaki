...
class IsoPtdHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','PDT')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-ptd.iso-ptd-holder-form');
    }
}
