...
class IsoPkgHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','PKG')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-pkg.iso-pkg-holder-form');
    }
}
