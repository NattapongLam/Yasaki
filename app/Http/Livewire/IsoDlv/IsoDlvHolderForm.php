...
class IsoDlvHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','DLV')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-dlv.iso-dlv-holder-form');
    }
}
