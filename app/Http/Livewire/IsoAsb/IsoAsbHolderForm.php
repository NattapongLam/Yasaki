...
class IsoAsbHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','ASB')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-asb.iso-asb-holder-form');
    }
}
