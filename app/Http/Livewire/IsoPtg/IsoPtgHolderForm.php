...
class IsoPtgHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','PTG')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-ptg.iso-ptg-holder-form');
    }
}
