...
class IsoMldHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','MLD')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-mld.iso-mld-holder-form');
    }
}
