...
class IsoStrHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','STR')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    {
        return view('livewire.iso-str.iso-str-holder-form');
    }
}
