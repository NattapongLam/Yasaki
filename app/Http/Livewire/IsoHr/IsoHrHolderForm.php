...
class IsoHrHolderForm extends Component
{
    public $idKey = 0;
    ...
    {
        $this->resetInput();
        $doc = IsoHolderList::where('emp_department_refcode','HR')->findOrFail($id);
        $this->idKey = $doc->id;
    ...
    public function save()
    {
        ...
        $this->dispatchBrowserEvent('swal',[
            ...
            'timer' => 3000,
            'icon' => 'success',
            'url' => route('isohr.list')
        ]);
        $this->emit('modalHide');
    }
    public function render()
    {
        return view('livewire.iso-hr.iso-hr-holder-form');
    }
}
