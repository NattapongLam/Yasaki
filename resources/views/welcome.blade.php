                                                    ...
                                                    <div class="col-xl-8">
                                                        <div>
                                                            <div class="row align-items-center">
                                                                <div class="col-4">
                                                                    <div>
                                                                        <h4 class="mb-0">ข่าวสาร บริษัท สื่ออินดัสเทรียล จำกัด</h4>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-muted">ผลิตสินค้าที่มีคุณภาพ ได้มาตรฐาน บริหารต้นทุนอย่างมีประสิทธิภาพ ส่งมอบสินค้าถูกต้อง ทันเวลา พัฒนาต่อเนื่อง เพื่อความพึงพอใจของลูกค้า</p>
