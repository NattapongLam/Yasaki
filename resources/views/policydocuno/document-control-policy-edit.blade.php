    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" class="form-horizontal" action="{{ route('policy.update',$pol->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12 col-md-4">
                        <label for="pol_date" class="col-form-label">วันที่</label>
                            <input type="date" class="form-control @error('pol_date') is-invalid @enderror" id="pol_date" name="pol_date" value="{{$pol->pol_date}}">
                            @error('pol_date')
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        ...
                        <input type="text" class="form-control @error('pol_name') is-invalid @enderror" id="pol_name" name="pol_name" value="{{$pol->pol_name}}">
                            @error('pol_name')
