...
<div class="row">
    ...
    @endif
    <form method="POST" class="form-horizontal" action="{{ route('mc_check.update',$hd->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-3">
                        ...
                        <input type="text" name="checksheetmc_hd_save" id="checksheetmc_hd_save" value="{{$hd->checksheetmc_hd_save}}"
                        class="form-control" readonly>
                        <input type="hidden" name="hd_id" id="hd_id" value="{{$hd->id}}">
                    </div>
                    <div class="col-12 col-md-3">
                        <label class="col-form-label" style="color: red">เลขที่ :</label>
                        <input type="text" name="checksheetmc_hd_docuno" id="checksheetmc_hd_docuno" value="{{$hd->checksheetmc_hd_docuno}}"
                        class="form-control" readonly>
                    </div>
                    <div class="col-12 col-md-3">
                        <label class="col-form-label" style="color: red">รหัสเครื่องจักร :</label>
                        <input type="text" name="ms_machine_code" id="ms_machine_code" value="{{$hd->ms_machine_code}}"
                        class="form-control" readonly>
                    </div>
                    <div class="col-12 col-md-3">
                        <label class="col-form-label" style="color: red">ชื่อเครื่องจักร :</label>
                        <input type="text" name="ms_machine_name" id="ms_machine_name" value="{{$hd->ms_machine_name}}"
                        class="form-control" readonly>
                    </div>        
                </div><hr>
                <div class="row">
                    <div class="col-12">
                        <center>
                            <img src="{{asset('assets/images/machinechecksheets/'.$hd->checksheetmc_hd_filename)}}" class="img-thumbnail" width="1000">
                        </center>                  
                    </div>               
                </div>
                <div class="row"> 
            ...
            <h3 class="card-title" style="color: red">ผู้ดำเนินการตรวจ</h3>
                @foreach ($chkemp as $key => $item)                   
                        <div class="col-12 col-md-3" style="border-style: ridge; border-collapse: separate;" >
                            ...
                            <input type="hidden" name="emp_id[]" id="emp_id[]" value="{{$item->id}}">
                            ...
                            หมายเหตุ :<input class="form-control" value="{{$item->checksheetmc_note_remark}}" name="checksheetmc_note_remark[]">
                        </div>    
                @endforeach 
            </div><br>
            <div class="row">
