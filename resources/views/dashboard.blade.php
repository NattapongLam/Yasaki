                                ...
                                <div class="card">
                                    <div class="card-body">     
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <h3 style="text-align: center">นโยบายด้านสิ่งแวดล้อมและด้านความปลอดภัย</h3>                         
                                            <h5 style="text-align: center">เพื่อให้เป็นการดำรงไว้ควบคุม ดูแลและจัดการบริหารงานด้านสิ่งแวดลอ้มและอาชีวอนามัยและความ
                                                ปลอดภัย ขององค์กร และระบบการจัดการให้มีประสิทธิภาพและเป็นไปอย่างต่อเนื่อง</h5>
                                            </div>
                                        </div><hr>                                                                                                                                                                   
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>หยุดวันขึ้นปีใหม่ (1 มกราคม)</td>
                                                        <td>1 วัน</td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>หยุดชดเชยวันสิ้นปี (2 มกราคม)</td>
                                                        <td>1 วัน</td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>หยุดวันมาฆบูชา (24 กุมภาพันธ์)</td>
                                                        <td>1 วัน</td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
                                                        <td>วันสงกรานต์ (13-16 เมษายน)</td>
                                                        <td>3 วัน</td>
                                                        <td>17,18,19,20 เมษายน ใช้พักร้อน</td>
                                                    </tr>
                                                    <tr>
                                                        <td>5</td>
                                                    ...
                                                    <tr>
                                                        <td>7</td>
                                                        <td>หยุดวันอาสาฬหบูชา (20 กรกฎาคม)</td>
                                                        <td>1 วัน</td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
