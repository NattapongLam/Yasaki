        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            <h3 class="card-title">บัญชีรายชื่อคอมพิวเตอร์และอุปกรณ์ระบบคอมพิวเตอร์ (YSK1-FM-ICT-01)</h3>
                        </div>
                        <div class="col-4">   
                            ...
                            <div class="vr"></div>
                            @livewire('iso-document-control-ict.document-control-ict-form')
                            <button type="button" class="btn btn-primary w-sm waves-effect waves-light"
                            data-bs-toggle="modal" data-bs-target="#exampleModal"data-bs-whatever="@mdo" wire:click="$emit('btnCreateDocumentControlIct')" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="col-1"><p>R.02-20230311</p></div>
                    </div>
                </div>                
            </div>
        </div>
