                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">   
                            ...
                            <div class="vr"></div>
                                @livewire('iso-document-control.document-control-kpi-form')
                                <button type="button" class="btn btn-primary w-sm waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#exampleModal"data-bs-whatever="@mdo" wire:click="$emit('btnCreateIsokpi')">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{$item->id}}</th>
                                    <td>{{\Carbon\Carbon::parse($item->kpi_date)->format('d/m/Y')}}</td>
                                    <td>{{$item->kpi_name}}</td>
                                    <td>{{$item->dep_name}}</td>
                                    ...
                                    <td>                                        
                                        <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal"data-bs-whatever="@mdo" wire:click="$emit('editIsokpi',{{$item->id}})">
